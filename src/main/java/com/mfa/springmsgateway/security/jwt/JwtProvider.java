...
public class JwtProvider implements IJwtProvider{
    ...
    private static final String JW_TOKEN_PREFIX = "Bearer";
    ...
    public String generateToken(UserPrincipal authentication){
        ...
        return Jwts.builder().setSubject(authentication.getUsername())
                ...
                .signWith(jwtPrivateKey, SignatureAlgorithm.PS512)
                .compact();
    }
    ...
    private  String resolveToken(HttpServletRequest request){
        ...
        if(bearerToken!=null &&bearerToken.startsWith(JW_TOKEN_PREFIX))
        {
